  ...
  render() {
    ...
    return (
      <label
        ...
        <input className='checkbox-btn_checkbox'
               type='checkbox' name={this.props.name} onChange={this.props.onChange}
               checked={this.props.value} disabled={disabled}/>
        <span className='checkbox-btn_checkbox-custom'
              style={this.props.color ? {background: this.props.color, borderColor: this.props.color} : {}}>
            <CheckIcon/>
          </span>
        {this.props.class === 'button' ?
          <span className='checkbox-btn_label-svg'>
              <CheckIcon className='checkbox-btn_label-check'/>
              <CloseIcon className='checkbox-btn_label-uncheck'/>
            </span> : ''}
        <span className='checkbox-btn_label'>
          {this.props.label}
          </span>
      </label>
    )
